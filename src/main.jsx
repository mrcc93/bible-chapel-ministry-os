...
function App() {
  ...
  return <div className="app-shell">
    <aside className="sidebar">
      ...
      <p className="sidebar-note">People Directory is D1/API-backed. Visitors, prayer requests, absences, and pastoral contacts are D1/API-backed. Stats, attendance, and giving stay local-only until a later phase.</p>
    </aside>
    <main className="main">
