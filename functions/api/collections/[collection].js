...
export async function onRequest(context) {
  ...
  // Phase 2B data gate: authentication and role authorization are enforced here,
  // but sensitive records are not exposed until collection-specific D1 queries,
  // validation, and audit logging are implemented.
  return json({
    collection,
    table,
    action,
